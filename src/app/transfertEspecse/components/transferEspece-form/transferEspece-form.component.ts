...
import { TransfertEspeceMulttipleBeneficiare } from '../../model/TransfertEspeceMulttipleBeneficiare';
...
export class TransferEspeceFormComponent implements OnInit {
  ...
  onFormSubmit(): void {
    ...
    let listVmb= new Array<TransfertEspeceMulttipleBeneficiare>() 
    for (let i = 0; i < this.listBenef.length; i++) {
      let vmb: TransfertEspeceMulttipleBeneficiare = {
